...
#The best practice is to have 'oc' on the test host logged in with a user (e.g. system:serviceaccount:myproject:arquillian)
...
#Make sure the 'default' SA in our $KUBERNETES_NAMESPACE can pull image from the CI/CD project 'myproject'
